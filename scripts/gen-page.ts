...
const render = (route: string, name: string) => {
  ...
  const pageViewPath = path.join('src/containers', route, 'index.tsx');
  const stylePath = path.join('src/containers', route, 'style.ts');
  // const testPath = path.join('src/containers', route, 'index.test.tsx');
